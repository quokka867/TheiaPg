...
typedef struct _THEIA_METADATA_BLOCK
{
    ...
    ULONG32 KPRCB_HalReserved_OFFSET;
    ULONG32 KPRCB_AcpiReserved_OFFSET;
    ULONG32 KPRCB_DpcData0_OFFSET;
    ULONG32 KPRCB_DpcData1_OFFSET;
    ULONG32 KPRCB_DpcStack_OFFSET;
    ULONG32 KPRCB_TimerTable_OFFSET;
    ...
    ULONG32 KTHREAD_Process_OFFSET;
    ...
    ULONG32 EPROCESS_ThreadListHead_OFFSET;
...
typedef struct _INPUTCONTEXT_ICH
{
    ULONG64 rcx;
    ULONG64 rdx;
    ULONG64 rbx;
...
}INPUTCONTEXT_ICH, *PINPUTCONTEXT_ICH;
